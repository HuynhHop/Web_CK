...
<section id="about-head" class="about-header">
    ...
    <div>
        <h2>Who We Are?</h2>
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aut itaque beatae recusandae et tempore. Mollitia a ad, recusandae, ut tempora nostrum quisquam ex non ullam veritatis aut tenetur maxime ducimus.</p>
        <abbr title="">Thức ăn gia súc uy tín</abbr>

        <marquee bgcolor="#ccc" loop="-1" scrollamount="S" width="100%">Lorem ipsum dolor sit amet consectetur adipisicing elit. Non totam porro placeat aut, explicabo, cum, quis ab consequuntur fuga deserunt dolorem. Asperiores nam expedita dolores excepturi perspiciatis corporis obcaecati est!</marquee>
    </div>
</section>
<!-- header-page section ends -->
